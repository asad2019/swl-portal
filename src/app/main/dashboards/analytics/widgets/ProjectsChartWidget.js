...
function ProjectsChartWidget(props) {
  const theme = useTheme();
  const widgets = useSelector(selectWidgets);
  const { series, delivered_projects, total_earning, new_projects, labels } =
    widgets?.projects_chart;
  ...
  return (
    <Paper className="flex flex-col flex-auto shadow rounded-2xl overflow-hidden">
      <div className="flex items-start justify-between m-24 mb-0">
        ...
        <div className="ml-8">
          <Chip size="small" className="font-medium text-sm" label=" This Year" />
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-42 sm:gap-48">
          <div className="flex flex-col">
            <div className="flex items-center">
              <div className="font-medium text-secondary leading-5">New Projects</div>
            ...
            <div className="flex items-start mt-8">
              <div className="text-4xl font-bold tracking-tight leading-none">{new_projects}</div>
          ...
          <div className="flex flex-col">
            <div className="flex items-center">
              <div className="font-medium text-secondary leading-5">Delivered Projects</div>
            ...
            <div className="flex items-start mt-8">
              <div className="text-4xl font-bold tracking-tight leading-none">{delivered_projects}</div>
              <div className="flex items-center ml-8">
          ...
          <div className="flex flex-col">
            <div className="flex items-center">
              <div className="font-medium text-secondary leading-5">Total Earning</div>
...
export default ProjectsChartWidget;
