...
function OpenProjectsWidget(props) {
  const widgets = useSelector(selectWidgets);
  const { series, labels, total } = widgets?.open_projects;
  ...
  const chartOptions = {
    ...
    colors: ['#319795', '#3bb8b5', '#4FD1C5', '#73f5e9'],
    labels,
    plotOptions: {
      pie: {
        customScale: 0.9,
...
export default memo(OpenProjectsWidget);
